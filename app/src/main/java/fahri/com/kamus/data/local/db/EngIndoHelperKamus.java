...
import static fahri.com.kamus.data.local.db.DatabaseContract.KamusColumnsEngInd.RESULT_WORD_ENG_IND;
import static fahri.com.kamus.data.local.db.DatabaseContract.KamusColumnsEngInd.SEARCH_WORD_ENG_IND;
import static fahri.com.kamus.data.local.db.DatabaseContract.TABLE_NAME_ENG_IND;

public class EngIndoHelperKamus  implements EngIndoKamusHelper {
    private static final String TAG = "EngIndoHelperKamus";
    ...
    @Inject
    public EngIndoHelperKamus(Context context, DatabaseHelper dataBaseHelper, PreferencesHelper preferencesHelper) {
    ...
    @Override
    public EngIndoHelperKamus openEngInd() throws SQLException {
